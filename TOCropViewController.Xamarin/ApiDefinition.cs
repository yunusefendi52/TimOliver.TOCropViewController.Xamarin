...
namespace TimOliver.TOCropViewController.Xamarin
{
	...
	interface TOCropViewController
	{
		...
		// -(void)setAspectRatioPreset:(TOCropViewControllerAspectRatioPreset)aspectRatioPreset animated:(BOOL)animated __attribute__((swift_name("setAspectRatioPresent(_:animated:)")));
